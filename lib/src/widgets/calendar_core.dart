...
class CalendarCore extends StatelessWidget {
  ...
  DateTime _getFocusedDay(
    ...
    switch (format) {
      case CalendarFormat.month:
        day = DateTime(prevFocusedDay.year, prevFocusedDay.month + pageDif);
        break;
      case CalendarFormat.twoWeeks:
        day = DateTime(prevFocusedDay.year, prevFocusedDay.month,
  ...
  DateTime _getBaseDay(CalendarFormat format, int pageIndex) {
    ...
    switch (format) {
      case CalendarFormat.month:
        day = DateTime(firstDay.year, firstDay.month + pageIndex);
        break;
      case CalendarFormat.twoWeeks:
        day = DateTime(
